...
<!--Menu Productos-->
                                    <li class="nav-item dropdown active">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <form action="index.php?action=registroProductos" method="GET">
                                                    <button class="dropdown-item" type="submit" name="action" value="registroProductos" class="btn btn-light">Registrar Producto</button>
                                                </form>
                                            </li>
                                            <li>
                                    ...
                                    <li class="nav-item dropdown active">
                                        <a class="nav-link dropdown-toggle text-white" data-bs-toggle="dropdown" role="button" aria-expanded="false">Reportes</a>
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <form action="index.php?action=productosAvencer" method="GET">
                                                        <button class="dropdown-item" type="submit" name="action" value="productosAvencer" class="btn btn-light">Productos a Vencer</button>
                                                    </form>
                                                </li> 
                                            </ul>
                                    </li>
