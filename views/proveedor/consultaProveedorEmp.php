...
<div class="row">
    ...
    <div class="col-8">
            ...
            <form class=" mt-4" action="index.php?action=consultaProveedorIdEmp" method="get">
                <div class="input-group mb-3">
                    <input type="hidden" class="form-control" name="action" value="consultaProveedorIdEmp">
            ...
            <table class="table table-hover text-white">
                ...
                <?php foreach ($proveedores as $proveedor): ?>
                    <tr>
                        ...
                        <a href="index.php?action=actualizarProveedorIdEmp&idProveedor=<?= $proveedor['idProveedor']; ?>" class="btn btn-outline-secondary text-white w-20" role="button">Actualizar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
