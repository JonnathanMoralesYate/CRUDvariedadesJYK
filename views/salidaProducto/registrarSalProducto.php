...
<div class="row">
            ...
            <form class=" mt-2" action="index.php?action=registroSalProductos" method="post">
                ...
                <div class="mt-2">
                    ...
                    <input type="text" class="form-control" name="numIdentCliente" placeholder="Numero de Cedula">
                </div>
                <div class="mt-2">
                    <label for="fechaSal" class="form-label text-white mt-3">Fecha Salida:</label>
                    <input type="datetime-local" class="form-control" name="fechaSal" placeholder="">
                </div>
                <div class="mt-2">
                    <label for="cantSal" class="form-label text-white mt-3">Cantidad de Salida:</label>
                    <input type="number" class="form-control" name="cantSal" placeholder="">
                </div>
                <div class=" mt-2">
                    <label for="precioVenta" class="form-label text-white mt-3">Precio Venta:</label>
                    <input type="number" class="form-control" name="precioVenta" placeholder="">
                </div>
