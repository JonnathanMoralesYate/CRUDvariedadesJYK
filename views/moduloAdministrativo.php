                                    ...
                                    <li class="nav-item dropdown active">
                                        <a class="nav-link dropdown-toggle text-white" data-bs-toggle="dropdown" role="button" aria-expanded="false">Empleados</a>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <form action="index.php?action=paginaP" method="GET">
                                                        <button class="dropdown-item" type="submit" name="action" value="paginaP" class="btn btn-light">Registrar Empleado</button>
                                                    </form>
                                                </li>
                                                <li>
                                                    <form action="index.php?action=" method="GET">
...
<!--Menu-->
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                                ...
                                <form action="index.php?action=loginP" method="GET">
                                    <button type="submit" class="btn btn-outline-secondary m-2 text-white" name="action" value="loginP">Login Out</button>
                                </form>
                        </div>
                </div>
            </nav>
