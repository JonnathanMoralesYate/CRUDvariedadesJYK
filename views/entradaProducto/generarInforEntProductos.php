...
<div class="row">
    ...
    <div class="col-8">
            ...
            <form class=" mt-5" action="index.php?action=reporteEntProductoFecha" method="get">
                <div class=" mt-2">
                ...
                <div class="text-center mt-2">
                    <button type="submit" class="btn btn-outline-secondary text-white mt-3 text-center" id="button-addon2">Consultar</button>
                </div>
            </form>
    </div>
    <div class="col-2">
