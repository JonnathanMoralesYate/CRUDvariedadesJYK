        ...
        <div class="col-2">
            ...
            <div class="mt-1">
                <div class="btn-group dropend w-100">
                    <button type="button" class="btn btn-outline-secondary text-white" aria-expanded="false" onclick="location.href='productos.php?clase=<?= $clase['idClase']; ?>'"><?= $clase['Clase']; ?></button>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
