<?php
        ...
        $query= "SELECT idCliente FROM clientes WHERE NumIdentificacion=?";
        $stmt = $mysqli->prepare($query);
        $stmt->bind_param('s', $clientes); // 's' para string
        $stmt->execute();
        ...
        $mysqli->close();
            ...
            echo json_encode(['success' => false, 'error' => 'Identificacion Cliente no recibido']);
        }
